...
package testcustomtextbox.proxies;
...
public class TestEntity
{
	 ...
	 */
	public static final java.lang.String entityName = "TestCustomTextBox.TestEntity";
	...
	{
		this(context, com.mendix.core.Core.instantiate(context, "TestCustomTextBox.TestEntity"));
	}
	...
	protected TestEntity(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject testEntityMendixObject)
	{
		...
		if (!com.mendix.core.Core.isSubClassOf("TestCustomTextBox.TestEntity", testEntityMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a TestCustomTextBox.TestEntity");
	...
	public static testcustomtextbox.proxies.TestEntity initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		return testcustomtextbox.proxies.TestEntity.load(context, mendixIdentifier);
	}
	 ...
	 */
	public static testcustomtextbox.proxies.TestEntity initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new testcustomtextbox.proxies.TestEntity(context, mendixObject);
	}

	public static testcustomtextbox.proxies.TestEntity load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return testcustomtextbox.proxies.TestEntity.initialize(context, mendixObject);
	}

	public static java.util.List<testcustomtextbox.proxies.TestEntity> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
		java.util.List<testcustomtextbox.proxies.TestEntity> result = new java.util.ArrayList<testcustomtextbox.proxies.TestEntity>();
		for (com.mendix.systemwideinterfaces.core.IMendixObject obj : com.mendix.core.Core.retrieveXPathQuery(context, "//TestCustomTextBox.TestEntity" + xpathConstraint))
			result.add(testcustomtextbox.proxies.TestEntity.initialize(context, obj));
		return result;
	}
	...
	public boolean equals(Object obj)
	{
		...
		{
			final testcustomtextbox.proxies.TestEntity that = (testcustomtextbox.proxies.TestEntity) obj;
	...
	{
		return "TestCustomTextBox.TestEntity";
	}
