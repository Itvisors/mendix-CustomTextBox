...
export async function GetDeviceInfo() {
	// BEGIN USER CODE
    if (typeof DeviceInfo.getDeviceCountry === "undefined" ||
        ...
        return Promise.reject(new Error("Some functions are not available using this version of GetDeviceInfo JS Action. Please update 'Native Mobile Resources' module using the App Store."));
    }
