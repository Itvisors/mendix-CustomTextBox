 ...
 * @returns {MxObject}
 */
function Geocode(address, geocodingProvider, providerApiKey) {
	// BEGIN USER CODE
  /**
   * Documentation:
  ...
  then(function (response) {return getLatLong(geocodingProvider, response);}).
  then(function (latLong) {return createMxObject(latLong[0], latLong[1]);});
